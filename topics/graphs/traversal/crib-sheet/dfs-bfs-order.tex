...
\begin{blocksection}
\question For each graph traversal, write the order returned. 
Break ties by least to greatest labels of each vertex. 
Assume that you start at node \lstinline{1}.
...
\begin{parts}
\part Give the depth-first traversal of the graph.
